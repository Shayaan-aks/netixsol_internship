"""
gen_nb.py — Script to generate code.ipynb and notebook.ipynb for Week 5 Day 3: LangGraph Agent
"""
import json
import os
...
for filename in ["code.ipynb", "notebook.ipynb"]:
    target_path = os.path.join(r"D:\Netixsol_Internship\netixsol_internship\Week-5\day-3", filename)
    with open(target_path, "w", encoding="utf-8") as f:
        json.dump(notebook_data, f, indent=1)
    print(f"Generated notebook: {target_path}")

print("gen_nb.py completed successfully.")
