...
# ── DATA LOADING ──────────────────────────────────────────────────────────────
cells.append(md_cell(["## Data Loading & Feature Engineering"]))
cells.append(code_cell([
    ...
    "print(f'Imbalance ratio       : {imbalance_ratio:.2f}:1  (negatives:positives)')\n"
]))
...
cells.append(code_cell([
    "# ── SHAP local explanations — 3 individuals ──────────────────────────────────\n",
    ...
    "        plt.show()\n",
    "else:\n",
    "    print('SHAP not available — showing top permutation-important features for each case.')\n",
    "    for label, idx in cases.items():\n",
    "        print(f'\\n--- {label} ---')\n",
    ...
    "                  above the decision boundary — the model correctly predicts >50K.\n",
...
print('Day-5 notebook written successfully!')
